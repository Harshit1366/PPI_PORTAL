...
public class EditDetails extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try{
	        ...
	        RecordsIMPL.updateKnowledge(rno, data, algo, log, cao, dbms, os, network, info, dev, pro, mob, mining ,sm, inter, app, fin, intel, hr, ms, er);
	        RecordsIMPL.updateSkills(rno, it, lis, oral, writ, body, con, ei, reso, prob, org, per, soc, inno, act, task ,obs, ana, nego, com ,time);
	        RecordsIMPL.updateAttitude(rno, pos, inte, dep, dis, ex, pers, ent, conf, init, far, team, des, open, ada, emp, conc, fair, mod, eth, clean);
