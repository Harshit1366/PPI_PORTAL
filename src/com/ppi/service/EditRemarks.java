...
/**
 * Servlet implementation class EditRemarks
 */
@WebServlet("/EditRemarks")
public class EditRemarks extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> know=(List<String>)sess.getAttribute("eknowledge");
        ...
        @SuppressWarnings("unchecked")
		List<String> skills=(List<String>)sess.getAttribute("eskills");
	    ...
	    try{
	        ...
	        sess.removeAttribute("eknowledge");
	        sess.removeAttribute("eskills");
