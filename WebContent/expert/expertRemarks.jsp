...
<div style="width: 100%;">
   <div style="float:left; width: 20%">
            ...
            <ul class="nav menu" style="margin-top: 0px">
             ...
             <li>
             <form method="post" action="../expert/expertRemarks.jsp">
  ...
  <form class="form-horizontal" role="form" action="../ExpRemarks" method="post">
                ...
                <div class="col-sm-4 col-sm-offset-0" style="background-color: rgba(255,255,255,0);border-radius: 10px;">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly value='<%=session.getAttribute("studroll")%>' id="id" name="id" required placeholder="Enter Student ID">
                        </div>
