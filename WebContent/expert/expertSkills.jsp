	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="../account/logout.jsp"><span
	...
	<div style="width: 100%;">
		<div style="float: left; width: 20%">
			<div id="sidebar"  class="col-sm-4 col-lg-12 sidebar collapse in">
				<div style="margin-left: 0px">
					<h3 class="text-left" style="color: #555D50;">PPI remaining
						students</h3>
				</div>
				...
				<ul class="nav menu" style="margin-top: 0px">
					<c:forEach items="${expert1}" var="studs">
						<li>
							<form method="post" action="../expert/expertSkills.jsp">
								<input type="hidden" value="<c:out value="${studs.roll}"/>"
									name="roll" /> <input type="hidden"
									value="<c:out value="${studs.name}"/>" name="name" /> <input
									type="submit" value="${studs.roll}">
							</form>
						</li>
				...
				<div style="margin-left: 0px">
					<h3 class="text-left" style="color: #555D50;">PPI Completed
						students</h3>
				</div>
						...
						<li>
							<form method="post" action="../expert/editKnowledge.jsp">
								<input type="hidden" value="<c:out value="${studs.roll}"/>"
									name="roll" /> <input type="hidden"
									value="<c:out value="${studs.name}"/>" name="name" /> <input
									type="submit" value="${studs.roll}"> <span
		...
		<div style="float: right; width: 80%">
			<div class="container">
				...
				<form class="form-horizontal" role="form" action="../ExpSkills"
					method="post">
									...
									<div class="col-sm-4 col-sm-offset-0" style="background-color: rgba(255, 255, 255, 0); border-radius: 10px;">
										...
										<div class="form-group">
											<label for="name" class="control-label">Name</label> <input
												type="text" readonly
												value='<%=session.getAttribute("studname")%>'
												class="form-control" id="name" name="name" required
												placeholder="Enter Student Name">
										</div>
										<div class="form-group">
											<label for="rno" class="control-label">Roll. No.</label> <input
												type="text" readonly
												value='<%=session.getAttribute("studroll")%>'
												class="form-control" id="rno" name="rno" required
										...
										<table class="table table-bordered">
											...
											<tbody>
												<tr>
													...
													<td>Team Spirit</td>
													<td><input type="radio" class="form" name="team" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="team" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="team" id=""
												...
												<tr>
													<td>Enthusiasm</td>
													<td><input type="radio" class="form" name="enth" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="enth" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="enth" id=""
												...
												<tr>
													...
													<td><input type="radio" class="form" name="conf" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="conf" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="conf" id=""
												...
												<tr>
													<td>Cleanliness</td>
													<td><input type="radio" class="form" name="clean"
														id="" value="1"></td>
													<td><input type="radio" class="form" name="clean"
														id="" value="2"></td>
													<td><input type="radio" class="form" name="clean"
												...
												<tr>
													...
													<td><input type="radio" class="form" name="oral" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="oral" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="oral" id=""
												...
												<tr>
													...
													<td>Body Language</td>
													<td><input type="radio" class="form" name="lang" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="lang" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="lang" id=""
												...
												<tr>
													...
													<td><input type="radio" class="form" name="prob" id=""
														value="1"></td>
													<td><input type="radio" class="form" name="prob" id=""
														value="2"></td>
													<td><input type="radio" class="form" name="prob" id=""
												...
												<tr>
													...
													<td><input type="radio" class="form" name="skill"
														id="" value="1"></td>
													<td><input type="radio" class="form" name="skill"
														id="" value="2"></td>
													<td><input type="radio" class="form" name="skill"
